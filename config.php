...
$core_config['db']['user'] = '35df373d83a7';	// database username
$core_config['db']['pass'] = 'de831d54583279a0';	// database password
$core_config['db']['name'] = 'celuavisos';	// database name
...
// logs directories
$core_config['apps_path']['logs'] = '/srv/users/serverpilot/apps/celuavisos/var/log/playsms';
